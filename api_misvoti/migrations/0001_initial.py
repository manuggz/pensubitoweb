...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_relacion', models.CharField(choices=[('RG', 'Regular'), ('GE', 'General'), ('EL', 'Electiva libre'), ('EA', 'Electiva de Area'), ('EX', 'Extraplan')], default='RG', max_length=2)),
                ('carrera', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_misvoti.CarreraUsb')),
                ('materia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_misvoti.MateriaBase')),
            ],
            options={
